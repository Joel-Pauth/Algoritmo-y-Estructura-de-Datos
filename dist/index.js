...
exports.people = exports.heroes = exports.inventory = exports.marcas = void 0;
...
function contarYOrdenarMarcas(marcas) {
    const marcasOrdenadas = marcas.sort();
    const total = marcasOrdenadas.reduce((contador) => contador + 1, 0);
    return { total, marcasOrdenadas };
}
const contar = exports.marcas.reduce((A) => A + 1, 0);
//metodo para que me ordene de la A a la Z 
exports.marcas.sort((A, B) => A.marca.localeCompare(B.marca));
console.log("Numero de marcas :", contar, "Orden alfabetico :", exports.marcas);
...
function Producto_con_Mucha_cantidad(inventory) {
    let maxQuantity = 0;
...
const producto_de_Inventorio = Producto_con_Mucha_cantidad(exports.inventory);
...
const city = exports.heroes.reduce((acc, hero) => {
...
const EdadesTotal = exports.people.reduce((sumarEdad, edades) => sumarEdad + edades.edad, 0);
const promedio = EdadesTotal / exports.people.length;
